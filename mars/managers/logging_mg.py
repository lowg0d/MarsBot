...
DEBUG = inter.get_inter("debug")
SAVE_LOGS = inter.get_inter("save-logs") #config.get_config("save_flight_logs") # Select True if you want your logs to save in a folder on the script directory.
